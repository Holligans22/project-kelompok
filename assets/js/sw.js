/** 14021204771220739338 */ self.document = self;
self.window = self;
var ytcfg = {
  d: function () {
...
ytcfg.set({
  EXPERIMENT_FLAGS: {
    ...
    html5_onesie_enable_profiler: true,
  ...
  INNERTUBE_CLIENT_VERSION: "2.20230622.06.02",
  INNERTUBE_CONTEXT: { client: { hl: "id", gl: "ID", clientName: "WEB", clientVersion: "2.20230622.06.02" } },
  INNERTUBE_CONTEXT_CLIENT_NAME: 1,
  INNERTUBE_CONTEXT_CLIENT_VERSION: "2.20230622.06.02",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
  const swPolicy = trustedTypes.createPolicy("youtubeServiceWorkerPolicy", {
    createScriptURL: function (ignored) {
      return "https://www.youtube.com/s/desktop/e768538b/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js";
    },
  });
  importScripts(swPolicy.createScriptURL(""));
} else {
  importScripts("https://www.youtube.com/s/desktop/e768538b/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js");
}
