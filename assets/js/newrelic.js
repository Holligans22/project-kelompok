...
var NR = window.newrelicAttributes;
NREUM.loader_config = { accountID: NR.accountId, trustKey: NR.trustKey, agentID: NR.agentId, licenseKey: NR.licenseKey, applicationID: NR.applicationId };
NREUM.info = { beacon: "bam-cell.nr-data.net", errorBeacon: "bam-cell.nr-data.net", licenseKey: NR.licenseKey, applicationID: NR.applicationId, sa: 1 };
